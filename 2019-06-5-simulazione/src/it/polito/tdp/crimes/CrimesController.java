...
public class CrimesController {
    ...
    private ComboBox<DayOfWeek> boxGiorno; // Value injected by FXMLLoader
    ...
    void doCreaReteCittadina(ActionEvent event) {
    	...
    	for(int i:model.getDistretti()) {
    		txtResult.appendText("Vicini del distretto "+i+"\n");
    		txtResult.appendText(model.getVicini(i));
    	}
    	boxMese.getItems().addAll(Month.values());
    	boxGiorno.getItems().addAll(DayOfWeek.values());
    }
